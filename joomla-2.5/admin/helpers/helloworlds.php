...
abstract class HelloworldsHelper
{
	...
	{
		JSubMenuHelper::addEntry(JText::_('Helloworlds'), 'index.php?option=com_helloworlds&view=helloworlds', $submenu == 'helloworlds');
		JSubMenuHelper::addEntry(JText::_('Categories'), 'index.php?option=com_categories&view=categories&extension=com_helloworlds', $submenu == 'categories');
